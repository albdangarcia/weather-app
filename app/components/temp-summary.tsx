    ...
    <div className="flex items-center justify-center mt-20 mb-12">
      <div className="w-96 text-center relative">
        <div className="relative">
          <span className="rounded-full h-64 w-[16rem] bg-[#FFB405] absolute z-0 left-24 top-0" />
          {/* <svg
                        viewBox="0 0 16 16"
                        className="h-64 w-[16rem] absolute z-0 left-24 top-0 fill-[#FFB405]"
                    >
        ...
        <p
          className={`${openSans.className} -top-4 relative font-semibold`}
        >
          {description}
        </p>
